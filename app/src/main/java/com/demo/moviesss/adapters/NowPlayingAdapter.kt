...
class NowPlayingAdapter(val onClickMovie: (NowPlayingPojo.NowPlayingResults) -> Unit) :
    RecyclerView.Adapter<NowPlayingAdapter.VH>() {

    private var moviesList: MutableList<NowPlayingPojo.NowPlayingResults> = mutableListOf()

    fun updateList(moviesList: MutableList<NowPlayingPojo.NowPlayingResults>) {
    ...
    inner class VH(private val binding: ListItemNowPlayingBinding) :
        ...
        fun bind(data: NowPlayingPojo.NowPlayingResults) {
            binding.run {
